...
- Plugin DLLs `nvigi.plugin.asr.ggml.d3d12.dll`, `nvigi.plugin.gpt.ggml.d3d12.dll` and `nvigi.plugin.tts.asqflow-ggml.d3d12.dll` - copy to SDK bin in `NVIGI-Plugins/bin/x64/`
